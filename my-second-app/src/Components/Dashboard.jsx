...
function Dashboard() {
  ...
  const fetchStats = async () => {
    try {
      const courses = await axios.get("https://studentmanagement-ew1r.onrender.com/courses");
      const subjects = await axios.get("https://studentmanagement-ew1r.onrender.com/subjects");
      const gpas = await axios.get("https://studentmanagement-ew1r.onrender.com/gpas");
      const attendance = await axios.get("https://studentmanagement-ew1r.onrender.com/attendance");
